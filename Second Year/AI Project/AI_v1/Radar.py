...
class Radar:
    ...
    def compute_detection_level(self, latitude: np.float32, longitude: np.float32) -> np.float32: # possibility this radar detects at lat,lon pos
        ...
        # debugging 
        # print("this radar is at: " + str(self.location.to_numpy()))
